...
if (Auth::user()->role == 0) {
    echo "<div class='sidebar'>
                ...
                <div class='sidebar-button'>
                    <a class='active' href='/kanban'><img src='/images/kanban.png' height='25' width='25'>Kanban Board</a>
                </div>
                <div class='sidebar-button'>
    ...
    <div class='sidebar-button'>
        <a class='active' href='/attendance'><img src='/images/dashboard.png' height='25' width='25'>Attendance</a>
    </div>
    <div class='sidebar-button'>
        <a class='active' href='/kanban'><img src='/images/dashboard.png' height='25' width='25'>Kanban Board</a>
    </div>
    <div class='sidebar-button'>
    ...
    <div class='sidebar-button'>
        <a class='active' href='/classlist'><img src='/images/dashboard.png' height='25' width='25'>Assign Class</a>
    </div>
    <div class='sidebar-button'>
        <a class='active' href='/attendance'><img src='/images/dashboard.png' height='25' width='25'>Attendance</a>
    </div>
