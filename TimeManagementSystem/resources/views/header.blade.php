...
<div class="header">
    ...
    <a href=""><img src="/images/settings.png" height="30px" width="30px"><text>Notifications</text></a>
        <a href=""><img src="/images/settings.png" height="30px" width="30px"><text>Settings</text></a>
    </div>
</div>